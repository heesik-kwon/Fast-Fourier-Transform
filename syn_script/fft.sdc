...
# 주기 설정: 500MHz = 2ns = 2000ps
set per500  "2000.00"   ;# 2000ps = 2ns

#set dont_care   "2"; 
#set min_delay   "0.3"; 

#set clcon_clk_name "CLK"
set cnt_clk_period   [expr {$per500 * $CLK_MGN}]        ;# 1400ps
set cnt_clk_period_h [expr {$cnt_clk_period / 2.0}]     ;# 700ps

### I/O DELAY per clock speed
set cnt_clk_delay    [expr "$per500 * $CLK_MGN * $io_dly"]  ;# 70ps
